...
// Initial dimension size
  ...
  static double dimen_667 = 667;

// FONT SIZE CONFIG

  static double subtitle1Size = 20;
  static double subtitle2Size = 18;
  static double buttonTextSize = 16;
  static double overlineSize = 14;
  static double captionSize = 12;

  static double bodyText2Size = 10;
  static double bodyText1Size = 12;

  static double headline6Size = 10;
  static double headline5Size = 12;
  static double headline4Size = 14;
  static double headline3Size = 16;
  static double headline2Size = 18;
  static double headline1Size = 20;
